...
const forecast=(latitude,longitude,callback)=>{
    ...
    request({url,json:true},(error,response)=>{
        if(error){
            ...
            callback(undefined,{data:response.body.daily.summary+"Its is currently "+response.body.currently.temperature
                +" degrees out. Theres is a " + response.body.currently.precipProbability+"% chance of rain"})
        }
